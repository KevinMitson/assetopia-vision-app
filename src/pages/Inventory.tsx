...
import { Laptop, Monitor, FileText, Printer } from 'lucide-react';
import { 
  Table, 
  TableBody, 
  TableCell, 
...
const assetData: Asset[] = [
  ...
  // Add additional assets for printers and contract management
  { id: 11, department: "Administration", user: "Reception Area", designation: null, equipment: "Printer", model: "HP LaserJet Pro", serialNo: "SN55667", assetNo: "AST011", pcName: "N/A", os: "N/A", ram: "N/A", storage: "N/A", purchaseDate: "2023-02-15", status: "Assigned", location: "Head Office", lastMaintenance: "2024-08-15", nextMaintenance: "2025-02-15", assignmentHistory: [
    { user: "Reception Area", department: "Administration", from: "2023-02-20", to: null, reason: "Office use" }
  ] },
  { id: 12, department: "IT", user: "Print Room", designation: null, equipment: "Printer", model: "Xerox WorkCentre", serialNo: "SN99887", assetNo: "AST012", pcName: "N/A", os: "N/A", ram: "N/A", storage: "N/A", purchaseDate: "2022-04-10", status: "Under Maintenance", location: "MIA", lastMaintenance: "2024-09-10", nextMaintenance: "2025-03-10", assignmentHistory: [
    { user: "Print Room", department: "IT", from: "2022-04-15", to: null, reason: "High-volume printing" }
  ] },
  { id: 13, department: "Legal", user: "Amanda Parker", designation: "Legal Counsel", equipment: "Contract Management", model: "N/A", serialNo: "LICENSE-001", assetNo: "AST013", pcName: "N/A", os: "Cloud-based", ram: "N/A", storage: "N/A", purchaseDate: "2023-06-01", status: "Assigned", location: "KKIA", lastMaintenance: "N/A", nextMaintenance: "N/A", assignmentHistory: [
    { user: "Amanda Parker", department: "Legal", from: "2023-06-01", to: null, reason: "Legal document management" }
  ] },
  { id: 14, department: "Procurement", user: "Thomas Yang", designation: "Contracts Manager", equipment: "Contract Management", model: "N/A", serialNo: "LICENSE-002", assetNo: "AST014", pcName: "N/A", os: "Cloud-based", ram: "N/A", storage: "N/A", purchaseDate: "2023-06-01", status: "Assigned", location: "MIA", lastMaintenance: "N/A", nextMaintenance: "N/A", assignmentHistory: [
    { user: "Thomas Yang", department: "Procurement", from: "2023-06-01", to: null, reason: "Vendor contract management" }
  ] },
  { id: 15, department: "IT", user: "Server Room", designation: null, equipment: "Printer", model: "Epson WorkForce", serialNo: "SN44556", assetNo: "AST015", pcName: "N/A", os: "N/A", ram: "N/A", storage: "N/A", purchaseDate: "2022-07-22", status: "Assigned", location: "HMNIA", lastMaintenance: "2024-07-22", nextMaintenance: "2025-01-22", assignmentHistory: [
    { user: "Server Room", department: "IT", from: "2022-07-25", to: null, reason: "Technical documentation printing" }
  ] }
];

// Updated chart data
const statusData = [
  { name: 'Assigned', value: 8, color: '#4caf50' },
  { name: 'Available', value: 1, color: '#2196f3' },
  { name: 'Under Maintenance', value: 2, color: '#ff9800' },
...
const equipmentData = [
  ...
  { name: 'Printer', value: 3, color: '#673ab7' },
  { name: 'Contract Management', value: 2, color: '#795548' }
];

const locationData = [
  { name: 'Head Office', value: 4, color: '#3f51b5' },
  { name: 'Stores', value: 2, color: '#9e9e9e' },
  { name: 'KKIA', value: 3, color: '#673ab7' },
  { name: 'HMNIA', value: 2, color: '#9c27b0' },
  { name: 'SMKIA', value: 1, color: '#e91e63' },
  { name: 'MIA', value: 2, color: '#ff5722' },
